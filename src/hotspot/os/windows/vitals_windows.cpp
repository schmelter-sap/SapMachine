...
static LoadAverageColumn* g_col_load_avg = nullptr;
...
bool platform_columns_initialize() {
  ...
  // Load average created by sampling.
  g_col_load_avg =
      define_column<LoadAverageColumn>("system", nullptr, "la", "The load average", has_loadavg);
